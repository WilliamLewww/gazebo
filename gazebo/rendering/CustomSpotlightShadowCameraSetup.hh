...
#ifndef GAZEBO_RENDERING_CUSTOMSPOTLIGHTSHADOWCAMERASETUP_HH_
#define GAZEBO_RENDERING_CUSTOMSPOTLIGHTSHADOWCAMERASETUP_HH_
...
namespace gazebo
{
  namespace rendering
  {
    class GAZEBO_VISIBLE CustomSpotlightShadowCameraSetup
          : public Ogre::DefaultShadowCameraSetup
    {
      /// \brief Constructor
      public: CustomSpotlightShadowCameraSetup();
